    ...
    return (
        <div className="react-repo-config light-mode">
            ...
            <p>
                ...
                <a href="https://nodejs.org/en/">Node JS</a>) and install
                version <b>16.18.0 LTS (Long Term Support)</b>.
            </p>
            <h2>2. Create new project</h2>
            <p>
                Once Node JS is installed, create a new project using{" "}
                <code>npm init</code>. This will create a new package.json file
                in the current folder you are.
            </p>
            <h2>3. Install React</h2>
            <p>
                The application is empty, so we have to specify that is going to
                be a React application. Thats why we have to install React and
                React DOM.
            </p>
            <ul>
                <li>
                    <b>React</b>: This library has all the utilities needed to
                    create React components.
                </li>
                <li>
                    <b>React DOM</b>: Is the bridge between the client and the
                    DOM and the server renderers for React.
                </li>
            </ul>
            ...
            <div>
                ...
                <ol>
                    <li>
                        ...
                        <pre>
                            <code>
                                npm install -D css-loader style-loader sass
                                sass-loader
                            </code>
                        </pre>
                    </li>
                    <li>
                        Introduce it on the <code>webpack.config</code> as a new
                        rule:{" "}
                        <pre>
                            <code>
                                {`{
        ...
        use: ["style-loader", "css-loader", "sass-loader"],
            ...
            <div>
                ...
                <p>
                    REM (Root Em) its a unit mesurement that represents the
                    font-size in the root of the page.
                </p>
                <p>
                    Go to the main stylesheet and, inside the html element,
                    specify the font size by default with:
        ...
        type: "asset/resource",
                ...
                <p>
                    To use in a TS file, is needed to import it as a module
                    using:{" "}
                    <code>
                        const pngExample =
            ...
            <div>
                ...
                <p>
                    Instead of that, create it as <code>tsconfig.json</code>,
